...
if (window.location.pathname === '/locate.html' || window.location.pathname === '/yourFolder/locate.html') {
...
const defaultMarker = L.marker([6.3249, 8.1137], { icon: L.icon({
  iconUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-icon-2x-red.png',
  iconSize: [25, 41],
  iconAnchor: [12, 41]
})}).addTo(map).bindPopup("Abakaliki, Ebonyi State, Nigeria").openPopup();
...
const geocoder = L.Control.geocoder({
  ...
  searchedMarker = L.marker(center, { icon: L.icon({
